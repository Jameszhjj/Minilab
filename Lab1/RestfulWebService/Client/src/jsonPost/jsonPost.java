...
public class jsonPost {
    ...
    public static String inputJson(String file) {
        ...
        try {
            ...
            System.out.println("***testLine33*** print sendString is"+sendString.toString());
            br.close();
        } catch (Exception e) {
    ...
    public static String receiveReturnCode(URLConnection connection) {
    	System.out.println("***testLine75*** print connection is"+connection.toString());
	...
	public static void main(String[] args) {
        ...
        String sendFile = "E:/Program Files/Java/workspace/IOFiles/searchBook.js";
